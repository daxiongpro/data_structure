...
from LinkedList2.statics.friendship_UI import Ui_MainWindow
from LinkedList2.util.LinkedList import *
from LinkedList2.util.Student import Student
# from LinkedList2.util.Student import *
